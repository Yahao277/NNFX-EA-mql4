//+------------------------------------------------------------------+
//|                                           StrategyOneV3-Copy.mq4 |
//|                        Copyright 2020, MetaQuotes Software Corp. |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+

//---
//* Copia del codigo de la version 3 original
//*
//----
...
bool manageLong()
{
   ...
   //--- One Candle Rule
   /*
   if(OneCandleForLong && ApplyOneCandleRule){
      LongSignal = checkLongConditions();
      Print("One Candle Checks: " + LongSignal);
...
bool checkLongConditions(){
   ...
   //Print(volumeIndicator.confirmationLong() +" " + baseline.baselineDirection() + " "+ c1.confirmationLong() +  c2.confirmationLong());
...
bool checkShortConditions(){
   ...
   //Print(volumeIndicator.confirmationShort() +" " + baseline.baselineDirection() + " "+ c1.confirmationShort() +  c2.confirmationShort());
