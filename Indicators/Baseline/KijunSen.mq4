...
#property description "Ichimoku KijunSen line"
#property strict

#property indicator_chart_window
#property indicator_buffers 9
#property indicator_color1 Red          // Tenkan-sen
#property indicator_color2 clrDodgerBlue         // Kijun-sen
...
double ATRminusBuffer[];
double ATRplusBuffer[];
...
//---
   ...
   SetIndexStyle(7,DRAW_LINE,STYLE_DOT,0,clrDodgerBlue);
   SetIndexBuffer(7,ATRminusBuffer);
   SetIndexLabel(7,"Kijun - ATR");
   
   SetIndexStyle(8,DRAW_LINE,STYLE_DOT,0,clrDodgerBlue);
   SetIndexBuffer(8,ATRplusBuffer);
   SetIndexLabel(8,"Kijun + ATR");
//---
   ExtBegin=InpKijun;
...
//--- counting from 0 to rates_total
   ...
   ArraySetAsSeries(ATRminusBuffer,false);
   ArraySetAsSeries(ATRplusBuffer,false);
   ...
   for(i=pos; i<rates_total; i++)
     {
      ...
      ATRminusBuffer[i] = ExtKijunBuffer[i] - iATR(_Symbol,_Period,14,i);
      ATRplusBuffer[i] = ExtKijunBuffer[i] + iATR(_Symbol,_Period,14,i);
     }
//--- Senkou Span A
   pos=ExtBegin-1;
